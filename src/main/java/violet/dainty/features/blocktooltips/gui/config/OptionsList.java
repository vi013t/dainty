...
import violet.dainty.features.blocktooltips.gui.config.value.CycleOptionValue;
import violet.dainty.features.blocktooltips.gui.config.value.InputOptionValue;
import violet.dainty.features.blocktooltips.gui.config.value.OptionValue;
import violet.dainty.features.blocktooltips.gui.config.value.SliderOptionValue;
...
public class OptionsList extends ContainerObjectSelectionList<OptionsList.Entry> {
	...
	public void updateSearch(String search) {
		...
		if (matches.isEmpty()) {
			addEntry(new Title(Component.translatable("gui.dainty.no_results").withStyle(ChatFormatting.GRAY)));
		}
	}
	...
	public void updateSaveState() {
		...
		if (invalidEntry == null) {
			...
			owner.saveButton.setTooltip(Tooltip.create(Component.translatable("gui.dainty.invalid_value_cant_save")));
		}
	}
	...
	public static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
		...
		public static String makeKey(String key) {
			return Util.makeDescriptionId("config", ResourceLocation.fromNamespaceAndPath(Dainty.MODID, key));
		}
	...
	public static class Title extends Entry {
		...
		public Title(String key) {
			...
			narration = Component.translatable("narration.dainty.category", title);
		}
