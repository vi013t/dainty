...
import violet.dainty.features.blocktooltips.api.callback.JadeAfterRenderCallback;
import violet.dainty.features.blocktooltips.api.callback.JadeBeforeRenderCallback;
import violet.dainty.features.blocktooltips.api.callback.JadeBeforeTooltipCollectCallback;
...
import violet.dainty.features.blocktooltips.api.config.IgnoreList;
import violet.dainty.features.blocktooltips.api.platform.CustomEnchantPower;
...
import violet.dainty.features.blocktooltips.gui.PluginsConfigScreen;
...
import violet.dainty.features.blocktooltips.impl.config.entry.BooleanConfigEntry;
import violet.dainty.features.blocktooltips.impl.config.entry.EnumConfigEntry;
import violet.dainty.features.blocktooltips.impl.config.entry.FloatConfigEntry;
import violet.dainty.features.blocktooltips.impl.config.entry.IntConfigEntry;
import violet.dainty.features.blocktooltips.impl.config.entry.StringConfigEntry;
import violet.dainty.features.blocktooltips.impl.lookup.HierarchyLookup;
import violet.dainty.features.blocktooltips.overlay.DatapackBlockManager;
...
public class WailaClientRegistration implements IWailaClientRegistration {
	...
	public static <T> JsonConfig<IgnoreList<T>> createIgnoreListConfig(
		...
		return new JsonConfig<>(Dainty.MODID + "/" + file, JadeCodecs.ignoreList(registryKey), null, () -> {
