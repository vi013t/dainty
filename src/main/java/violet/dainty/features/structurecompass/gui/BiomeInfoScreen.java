...
public class BiomeInfoScreen extends Screen {
	...
	private void setupWidgets() {
		clearWidgets();
		addRenderableWidget(new TransparentButton(10, height - 30, 110, 20, Component.translatable("string.naturescompass.back"), (onPress) -> {
			minecraft.setScreen(parentScreen);
		}));
		addRenderableWidget(new TransparentButton(width - 120, height - 30, 110, 20, Component.translatable("string.naturescompass.search"), (onPress) -> {
