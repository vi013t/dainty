...
public class NaturesCompassClient {
	...
	public static void clientInit(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			ItemProperties.register(StructureCompass.naturesCompass, ResourceLocation.fromNamespaceAndPath(Dainty.MODID, "angle"), new ClampedItemPropertyFunction() {
				@OnlyIn(Dist.CLIENT)
    ...
    public static void registerOverlay(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.BOSS_OVERLAY, ResourceLocation.fromNamespaceAndPath(Dainty.MODID, "structure_compass"), new NaturesCompassOverlay());
    }
