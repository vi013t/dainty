...
import violet.dainty.features.playerspecificloot.common.block.LootrInventoryBlock;
import violet.dainty.features.playerspecificloot.common.block.LootrShulkerBlock;
import violet.dainty.features.playerspecificloot.common.block.LootrTrappedChestBlock;
import violet.dainty.features.playerspecificloot.common.block.TrophyBlock;
import violet.dainty.features.playerspecificloot.common.block.entity.LootrShulkerBlockEntity;


public class ModBlocks {
  private static final DeferredRegister<Block> REGISTER = DeferredRegister.create(BuiltInRegistries.BLOCK, Dainty.MODID);
