...
/**
 * Helper class for getting colors for sprites for purposes of implementing {@link violet.dainty.features.recipeviewer.core.commonapi.ingredients.IIngredientHelper#getColors(Object)}.
 * Get an instance from {@link violet.dainty.features.recipeviewer.core.commonapi.registration.IModIngredientRegistration#getColorHelper()}
 *
 * @since 7.6.3
 */
