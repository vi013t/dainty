...
import violet.dainty.features.recipeviewer.core.gui.recipes.lookups.StaticFocusedRecipes;
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (recipeCategoryTitle.isMouseOver(mouseX, mouseY)) {
			...
			if (!logic.hasAllCategories()) {
				tooltip.addKeyUsageComponent("dainty.tooltip.show.all.recipes.hotkey", keyBindings.getLeftClick());
			}
			tooltip.draw(guiGraphics, mouseX, mouseY);
		}
