package violet.dainty.features.recipeviewer.core.commonapi.gui.builder;
...
public interface IRecipeLayoutBuilder {
	...
	/**
	 * Assign this slot to a {@link violet.dainty.features.recipeviewer.core.commonapi.gui.widgets.ISlottedWidgetFactory},
	 * so that the widget can manage this slot instead the recipe category.
	 *
	 * @param widgetFactory the {@link violet.dainty.features.recipeviewer.core.commonapi.gui.widgets.ISlottedWidgetFactory} to assign this slot to.
	 *
	 * @since 19.7.0
	...
	IRecipeSlotBuilder addSlotToWidget(RecipeIngredientRole role, violet.dainty.features.recipeviewer.core.commonapi.gui.widgets.ISlottedWidgetFactory<?> widgetFactory);
