...
public interface IGuiHelper {
	 ...
	 *
	 * Add ingredients to it using {@link IRecipeLayoutBuilder#addSlotToWidget(RecipeIngredientRole, violet.dainty.features.recipeviewer.core.commonapi.gui.widgets.ISlottedWidgetFactory)}
	 *
	 * @since 19.7.0
	...
	violet.dainty.features.recipeviewer.core.commonapi.gui.widgets.IScrollGridWidgetFactory<?> createScrollGridFactory(int columns, int visibleRows);
